...
var activateVideo = function activateVideo() {
  ...
  var player = document.querySelector('.gym__video-player');
  var link = document.querySelector('.gym__video-button');
  var boxVideo = document.querySelector('.gym__video');
